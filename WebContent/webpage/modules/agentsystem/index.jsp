	...
	<div id="main-wrapper">
				...
				<div class="user-profile" style="background: url(${ctxStatic}/assets/images/background/user-info.jpg) no-repeat;">
					...
					<div class="profile-img">
						...
						<c:choose>  
						  	...
						  	<c:otherwise>
								<img id="userSrc" src="${vicmobAgentSystemUserPhoto}" style="width: 50px; height: 50px"/>
						   	</c:otherwise>  
						</c:choose>
					...
					<div class="profile-text">
						...
						<div class="dropdown-menu animated flipInY">
							...
							<a class="dropdown-item" href="#" onclick="changePassword('${vicmobAgentSystemLoginName}')">
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				<div class="row page-titles" style="box-shadow: inset 1px -1px 0px #dad3d3;">
