...
<body>
							...
							<c:forEach items="${page.list}" var="log">
								<tr>
									...
									<td class="tableControl">
											...
											<button type="button" data-toggle="tooltip" data-original-title="物流" class="btn btn-info btn-circle btn-xs" onclick="express('${log.expressCoding}','${log.expressNumber}',this)">
	...
	$('#keywordOne').bind('keypress', function(event) {
		...
		function confirm(invoiceId) {
			...
			layer.confirm("发票已妥投？", {closeBtn: 0, icon : 3 ,skin : 'layui-layer-molv',btn: ['确认','取消']}, 
					function(){
						var index = layer.load(1, {shade: [0.1,'#fff']});
						$.ajax({
