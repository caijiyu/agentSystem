	...
	<div id="wrapper" style="display: block;">
					...
					<div class="s_form_wrapper soutu-env-nomac soutu-env-index">
						...
						<form id="form" name="f" action="" class="fm" onsubmit="return false;">
							<span class="bg s_ipt_wr quickdelete-wrap"> <span
								...
								maxlength="255" placeholder="请输入代理商公司全称">
							</span><span class="bg s_btn_wr"><input type="button" id="su" style="height:34.8px"
								value="查询" class="bg s_btn" onclick="lookSearch();"></span> <span
			...
			<div id="qrcode">
				<div class="qrcode-item qrcode-item-1">
					<div class="qrcode-img">
						<img style="width: 100px;height: 100px;" src="${ctxStatic}/agentSystem/img/qrcode.jpg">
					</div>
		...
		<div id="ftCon">
			<div class="ftCon-Wrapper">
				<div id="ftConw">
					<p id="cp">
						Copyright © 2011-2030 &nbsp;www.vicmob.com.&nbsp; <a href="">无锡微炫客信息技术有限公司版权所有</a>&nbsp;
						<a href="http://www.miitbeian.gov.cn" class="cp-feedback">&nbsp;苏ICP备15062425号&nbsp;</a><i
							class="c-icon-icrlogo"></i>&nbsp; <a id="jgwab" target="_blank"
							href="">地址： 无锡市惠山区江苏数字信息产业园智慧路1号清华创新大厦20层</a>&nbsp;<i class=""></i>
					</p>
				</div>
			</div>
		</div>
