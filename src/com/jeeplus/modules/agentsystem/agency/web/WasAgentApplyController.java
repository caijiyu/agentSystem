...
public class WasAgentApplyController extends BaseController {
@Autowired
...
public static final String  AGENT="代理商";		
	...
	public Integer pass(WasSysUser wasSysUser){
		...
		Subject subject = SecurityUtils.getSubject();
		Principal principal = (Principal)subject.getPrincipal(); 
		wasAgentApplyService.pass(wasSysUser);
	...
	public Integer saveRole(WasSysUser sysUser,String oldName,String oldPassword,String operation,String startDateA,String endDateA,String agentLevelIdA
		...
		if (sysUser.getPackageDiscount() == null) {
			sysUser.setPackageDiscount(new BigDecimal("10"));
		}
		if (sysUser.getPublicDiscount() == null) {
			sysUser.setPublicDiscount(new BigDecimal("10"));
		}
		if (sysUser.getMinaDiscount() == null) {
			sysUser.setMinaDiscount(new BigDecimal("10"));
		}
		Subject subject = SecurityUtils.getSubject();
		Principal principal = (Principal)subject.getPrincipal(); 
