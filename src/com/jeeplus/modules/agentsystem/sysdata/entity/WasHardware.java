...
public class WasHardware extends DataEntity<WasHardware> {
	...
	public String getPicture() {
		return HtmlUtils.htmlUnescape(picture);
	}

	public void setPicture(String picture) {
		this.picture = HtmlUtils.htmlUnescape(picture);
	}
	...
	public String getClassify() {
		return HtmlUtils.htmlUnescape(classify);
	}

	public void setClassify(String classify) {
		this.classify = HtmlUtils.htmlUnescape(classify);
	}
