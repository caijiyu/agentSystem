...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("</button>");
		sb.append("<ul class=\"dropdown-menu\" style=\"font-size:13px\" role=\"menu\">");
		sb.append("<li class=\""+getSelected(pageSize,10)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",10);\">10</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,25)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",25);\">25</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,50)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",50);\">50</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,100)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",100);\">100</a></li>");
		sb.append("</ul>");
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"paginate_button previous disabled\"><a style=\"cursor: not-allowed;\" href=\"javascript:\"><i class=\"fa fa-angle-double-left\"></i></a></li>\n");
			sb.append("<li class=\"paginate_button previous disabled\"><a style=\"cursor: not-allowed;\" href=\"javascript:\"><i class=\"fa fa-angle-left\"></i></a></li>\n");
		} else {
		...
		if (begin > first) {
			...
			if (i < begin) {
				sb.append("<li  class=\"paginate_button disabled\"><a style=\"cursor: not-allowed;\" href=\"javascript:\">...</a></li>\n");
			}
		}
		...
		if (pageNo == last) {
			sb.append("<li class=\"paginate_button next disabled\"><a style=\"cursor: not-allowed;\" href=\"javascript:\"><i class=\"fa fa-angle-right\"></i></a></li>\n");
			sb.append("<li class=\"paginate_button next disabled\"><a style=\"cursor: not-allowed; border-right: 1px solid #e9ecef;\" href=\"javascript:\" style=\"border-right: 1px solid #e9ecef;\"><i class=\"fa fa-angle-double-right\"></i></a></li>\n");
		} else {
			sb.append("<li class=\"paginate_button next\"><a href=\"javascript:\" onclick=\""+funcName+"("+next+","+pageSize+");\">"
					+ "<i class=\"fa fa-angle-right\"></i></a></li>\n");
			sb.append("<li class=\"paginate_button next\"><a style=\"border-right: 1px solid #e9ecef;border-right: 1px solid #e9ecef;\" href=\"javascript:\" onclick=\""+funcName+"("+last+","+pageSize+");\">"
