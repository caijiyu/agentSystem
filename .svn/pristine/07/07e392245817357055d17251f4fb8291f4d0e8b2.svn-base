...
<script type="text/javascript"
	src="${ctxStatic}/TableDnD/jquery.tablednd.js"></script>
...
<link href="${ctxStatic}/dataTables/dataTables.bootstrap.css"
	rel="stylesheet" />
...
<link href="${ctxStatic}/awesome/4.4/css/font-awesome.min.css"
	rel="stylesheet" />
<link href="${ctxStatic}/common/css/style.css?v=3.2.0" type="text/css"
	rel="stylesheet" />
...
<link rel="stylesheet" type="text/css"
	href="${ctxStatic}/webuploader-0.1.5/webuploader.css">
<script type="text/javascript"
	src="${ctxStatic}/webuploader-0.1.5/webuploader.js"></script>


<!-- 引入自定义文件 -->
<script src="${ctxStatic}/common/mustache.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/content.js" type="text/javascript"></script>
<link href="${ctxStatic}/common/css/animate.css" type="text/css"
	rel="stylesheet" />
<link href="${ctxStatic}/common/css/login.css" type="text/css"
	rel="stylesheet" />
<script type="text/javascript">
