							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group row">
										<label class="col-md-3 col-form-label">
											<span id="theaterSpan" style="color: red">*&nbsp;</span>所属战区：</label>
										<div class="col-md-9">
											<div>
												<input type="text" class="form-control"  maxlength="20"  id="theater" name="theater">
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<div class="input-daterange input-group" id="date-range">
												...
												<input type="text" autocomplete="off" class="form-control leftAngle height-control" name="endDateA">
											</div>
								...
								<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<div>
												<input type="text" class="form-control"  maxlength="30" id="principal"	name="principal">
												<span class="help-block">二级代理商无需填写此项</span>
											</div>
										</div>
									</div>
