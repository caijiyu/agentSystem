									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<div class="input-daterange input-group" >
												...
												<input type="text" autocomplete="off" class="form-control height-control leftAngle" name="endDate" id="endDate">
											</div>
											<label id="endDate-error" class="error" for="endDate" style="margin-left:54%"></label>
										</div>
