	...
	<div class="divControl">
		<div class="card cardControl">
			...
			<div class="tab-content">
				...
				<div class="row p-t-20">
					...
					<div class="col-md-6">
						<div class="form-group has-danger row">
							...
							<label class="control-label col-7" style="white-space: pre-wrap;text-align: left;">${fn:escapeXml(page.list[0].body)}</label>
						</div>
					</div>
					<!--/span-->
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<label class="control-label col-7" style="white-space: pre-wrap;text-align: left;">${fn:escapeXml(page.list[0].companyName)}</label>
						</div>
					</div>
					<!--/span-->
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<label class="control-label col-7" style="white-space: pre-wrap;text-align: left;">${fn:escapeXml(page.list[0].address)}</label>
						</div>
					</div>
					<!--/span-->
					<div class="col-md-6">
				...
				<c:if test="${page.list[0].invoiceType eq '专用发票'}">
				<div class="row" id="dedicatedA">
					<div class="col-md-6">
						<div class="form-group row">
							<label class="control-label col-3" style="text-align: right;">注册地址：</label>
							<label class="control-label col-7" style="white-space: pre-wrap;text-align: left;">${fn:escapeXml(page.list[0].registerAddress)}</label>
						</div>
					</div>
					<!--/span-->
					<div class="col-md-6">
				...
				<div class="row" id="dedicatedB">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<label class="control-label col-7" style="white-space: pre-wrap;text-align: left;">${fn:escapeXml(page.list[0].registerBank)}</label>
						</div>
					</div>
					<!--/span-->
					<div class="col-md-6">
					...
					<tbody style="max-height:165px;">
						<c:forEach items="${pageB}" var="log">
							<tr>
								...
								<td class="tableControl">${fn:escapeXml(log.expendSum)}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
				...
				<div class="dataTables_wrapper">
					<div class="dataTables_paginate"style="margin-bottom: 15px; margin-top: -15px;margin-right: 15px;">
						<button type="button" onclick="examineBack('${page.list[0].applyBy}')" class="btn btn-default" style="background-color: #DDDDDD;height: 35px;">返回</button>
					</div>
				</div>
