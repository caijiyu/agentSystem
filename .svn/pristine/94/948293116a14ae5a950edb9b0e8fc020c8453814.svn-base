(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: '取消', okText: '确定', clearText: '清除', nowText: '现在', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
   ...
   Plugin.prototype =
           {
              ...
              showDate: function (date)
              {
                 if (date) {
                	 var week = ""
                	 if(date.locale(this.params.lang).format('dddd') == "Tuesday"){
                		 week = "星期二"
                	 } else if(date.locale(this.params.lang).format('dddd') == "Wednesday"){
                		 week = "星期三"
                	 } else if(date.locale(this.params.lang).format('dddd') == "Thursday"){
                		 week = "星期四"
                	 } else if(date.locale(this.params.lang).format('dddd') == "Friday"){
                		 week = "星期五"
                	 } else if(date.locale(this.params.lang).format('dddd') == "Monday"){
                		 week = "星期一"
                	 } else if(date.locale(this.params.lang).format('dddd') == "Saturday"){
                		 week = "星期六"
                	 } else if(date.locale(this.params.lang).format('dddd') == "Sunday"){
                		 week = "星期日"
                	 }
                	 this.$dtpElement.find('.dtp-actual-day').html(week);
                	 this.$dtpElement.find('.dtp-actual-month').html(date.locale(this.params.lang).format('MM').toUpperCase()+'月');
                	 this.$dtpElement.find('.dtp-actual-num').html(date.locale(this.params.lang).format('DD')+'日');
                	 this.$dtpElement.find('.dtp-actual-year').html(date.locale(this.params.lang).format('YYYY')+'年');
                 }
              },
              ...
              constructHTMLCalendar: function (date, calendar)
              {
                 ...
                 _template += '<div class="dtp-picker-month">' + date.locale(this.params.lang).format('YYYY年MM月') + '</div>';
