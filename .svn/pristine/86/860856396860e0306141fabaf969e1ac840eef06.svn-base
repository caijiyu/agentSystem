						...
						<div class="form-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group row">
										<label class="col-md-3 col-form-label">
											<span id="theaterSpan"  style="color: red">*&nbsp;</span>所属战区：
										</label>
										<div class="col-md-9">
											<div>
												<input type="text" class="form-control"  maxlength="10" id="theater" name="theater">
									...
									<div class="form-group row">
										<label class="col-md-3 col-form-label">套餐折扣：</label>
										<div class="col-md-9">
											<div>
									...
									<div class="form-group row">
										<label class="col-md-3 col-form-label">公众号折扣：</label>
										<div class="col-md-9">
											<div>
												<div class="input-group">
									...
									<div class="form-group row">
										<label class="col-md-3 col-form-label">小程序折扣：</label>
										<div class="col-md-9">
											<div>
												<div class="input-group">
								...
								<div class="col-md-6">
									...
									<div class="form-group row">
										<label class="col-md-3 col-form-label">
											<span id="principalSpan" style="color: red">*&nbsp;</span>战区负责人：
										</label>
										<div class="col-md-9">
											<div>
												<input type="text" class="form-control"  maxlength="10"  id="principal"	name="principal">
												<span class="help-block">二级代理商无需填写此项</span>
											</div>
										</div>
									</div>
			...
			$("#addForm").validate(
					{
						...
						messages:{
							login_name : {
								required : "请输入账户名称",
								minlength : "账户名称至少为5位字符",
								maxlength : "账户名称最多为15位字符",
								remote : "此账户名已经注册过"
							},
							password : {
								required : "请输入密码",
						...
						errorPlacement : function(error, element) {	
							if(element.attr("id")=="province"){
			            		...
			            		error.insertAfter(element.parent().parent());
			            	}else if(element.attr("name")=="mobile"||element.attr("name")=="name"||element.attr("name")=="theater"||element.attr("name")=="principal"){
			...
			if (isValid) {
				layer.confirm('是否确认保存？', { icon : 3 ,closeBtn: 0,
					...
					if(!locked){
						...
						locked=true;
						if($("#theaterSpan").css("display")=="none"&&$("#principalSpan").css("display")=="none"){
							$("#theater").attr("name","");
							$("#principal").attr("name","");
						}
