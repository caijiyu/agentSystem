...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false,showIcon:false},check:{enable:"${checked}",nocheckInherit:true},
...
<body>
	<div id="tree" class="ztree" style="padding:15px 20px;background-color: white;"></div>
</body>